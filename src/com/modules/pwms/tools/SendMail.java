...
//	            subject = transferChinese(subject);  
	    ...
	    public static void main(String[] args) {  
	        ...
	        sendmail.setUserName("officialsa2ee@163.com");//您的邮箱用户名  
	        sendmail.setPassWord("11223344556");//您的邮箱密码  
	        sendmail.setTo("327650570@qq.com");//接收者  
	        sendmail.setFrom("officialsa2ee@163.com");//发送者  
	        sendmail.setSubject("测试！");  
	        sendmail.setContent("test测试！");  
